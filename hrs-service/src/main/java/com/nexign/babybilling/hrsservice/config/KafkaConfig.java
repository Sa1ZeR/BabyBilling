...
import com.nexign.babybilling.hrsservice.config.property.KafkaConsumerProperty;
...
public class KafkaConfig {
    ...
    @Bean
    public NewTopic calcTopic() {
        return TopicBuilder.name(kafkaProducerProperty.calcDataTopic)
                .partitions(1)
